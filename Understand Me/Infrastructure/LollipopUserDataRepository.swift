...
class LollipopUserDataRepository: UserDataRepository {
    ...
    func updateFCMToken(userID: String, fcmToken: String) async throws {
        ...
        let request = try await lollipopAPIUtility.makeRequest(url: url, method: "UPDATE", body: bodyData)
        let (data, _) = try await URLSession.shared.data(for: request)
    ...
    func deleteUserData(userID: String) async throws {
        ...
        let request = try await lollipopAPIUtility.makeRequest(url: finalURL, method: "DELETE")
